...
BeanstalkCommand.prototype.onSuccess = function(callback) {
	...
	this.addListener('command_done', function(data) {
		this.self.emit('command_next', data);
		callback(data);
	});
};

BeanstalkCommand.prototype.onError = function(callback) {
	var self = this;
	this.addListener('command_error', function(data) {
		this.self.emit('command_next', data);
		callback(data);
	});
};
...
BeanstalkClient.prototype.command = function(obj) {
    ...
    cmd.addListener('command_next', function(data) {
